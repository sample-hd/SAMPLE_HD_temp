...
for instr_idx in range(start_idx, end_idx + 1):

    with open(instr_path, 'r') as f:
        target_instr = json.load(f)["instructions"][instr_idx]

    scene_json = "/home/michas/Desktop/SAMPLE_HD/scenes/SAMPLE_HD_train_{:06d}.json".format(
    ...
    with open(info_dict['scene_json'], 'r') as f:
        ...
        for i in range(10000):
            ...
            if current_act is None:
                ...
                if current_act == "MoveOver":
                    ...
                    scale = scene[current_targ]["scaling"]['x']
